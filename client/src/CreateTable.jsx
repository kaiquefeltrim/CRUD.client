    ...
    <div className="flex items-center bg-gray-700 justify-center h-screen">
      <div className="flex flex-col items-center bg-gray-900 mt-3 p-6 rounded-lg w-96">
        ...
        <form className="w-full" onSubmit={handleSave}>
          <div className="mb-4">
            <label htmlFor="floating_email" className="text-white text-sm mb-1">Email address:</label>
            <input
              type="email"
              name="floating_email"
              id="floating_email"
          ...
          <div className="mb-4">
            <label htmlFor="date" className="text-white text-sm mb-1">Data:</label>
            <input
              type="date"
              name="date"
              id="date"
          ...
          <div className="mb-4">
            <label htmlFor="floating_phone" className="text-white text-sm mb-1">Phone Number:</label>
            <input
              type="tel"
              name="floating_phone"
              id="floating_phone"
