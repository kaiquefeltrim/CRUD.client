...
const ModalService = () => {
  ...
  return (
    <div id="ModalService" tabIndex="-1" aria-hidden="true" className="ModalService overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form onSubmit={handleSave} className="p-4 md:p-5">
            <div className="grid gap-4 mb-4 grid-cols-2">
              ...
              <div className="grid gap-4 mb-4 grid-cols-2">
                <label htmlFor="serv_money" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price</label>
